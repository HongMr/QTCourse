    ...
    , ui(new Ui::MainWindow)
{
    ...
    header->setText(MainWindow::colDate,"最后的修改日期");
    ...
    //添加一个根节点
    QIcon icon(":/icons/images/addFolder.png");
    QTreeWidgetItem *topItem = new QTreeWidgetItem(itTopItem);
    topItem->setIcon(MainWindow::colItem,icon);
    topItem->setText(MainWindow::colItem,"图片");
    topItem->setText(MainWindow::colItemType,"Top Item");
...
void MainWindow::on_actAddFolder_triggered()
{
    ...
    if(parItem->type() != itImageItem)
    {
        ...
        QIcon icon(":/icons/images/citiy_2.png");
...
void MainWindow::on_actAddFiles_triggered()
{
    ...
    for(int i = 0; i < files.size();++i)
    {
        ...
        QIcon icon(":/icons/images/add_files.png");
...
void MainWindow::on_actScanItems_triggered()
{
    for(int i = 0; i < ui->treeWidget->topLevelItemCount();++i)
    {
        ...
        changeItemCaption(ui->treeWidget->takeTopLevelItem(i));
    }
}
